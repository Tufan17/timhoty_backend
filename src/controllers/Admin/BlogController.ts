...
export default class BlogController {
	...
	async findOne(req: FastifyRequest, res: FastifyReply) {
		try {
			...
			const blog = await knex("blogs").where("blogs.id", id).whereNull("blogs.deleted_at").leftJoin("blog_pivots", "blogs.id", "blog_pivots.blog_id").where("blog_pivots.language_code", req.language).select("blogs.*", "blog_pivots.title as title", "blog_pivots.description as description").groupBy("blogs.id", "blog_pivots.title", "blog_pivots.description").first()
