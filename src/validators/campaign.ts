...
export const campaignSchema = Joi.object({
  ...
  service_type: Joi.string().valid("hotel", "rental", "activity", "tour", "visa", "sales_partner").required(),
...
export const campaignUpdateSchema = Joi.object({
  ...
  service_type: Joi.string().valid("hotel", "rental", "activity", "tour", "visa", "sales_partner").optional(),
